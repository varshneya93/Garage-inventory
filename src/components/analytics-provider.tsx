...
export function AnalyticsProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    // Initialize external analytics services once
    if (!initialized.current && hasAnalyticsConsent()) {
  ...
  useEffect(() => {
    ...
    if (hasAnalyticsConsent()) {
      ...
      trackExternalPageView(pathname);
    }
  }, [pathname]);
...
function initializeExternalAnalytics() {
...
function trackExternalPageView(pathname: string) {
  if (typeof window === 'undefined') return;
